...
### 备注
- 内容为转载，实践过程中可能由于Jekyll版本不一致，需要gem其他版本的插件
- 运行方式*bundle exec jekyll serve -w --host=0.0.0.0*
- 指定端口运行在_config.yam下面增加 *post:4001*

## **以下为转载内容**
转载自[Jekyll搭建个人博客](http://baixin.io/2016/10/jekyll_tutorials1/)
### 介绍
